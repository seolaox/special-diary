          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('   ❮My Special Diary❯는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다. 정보주체로부터 동의받은 개인정보 보유기간이 경과하거나 처리목적이 달성되었음에도 불구하고 다른 법령에 따라 개인정보를 계속 보존하여야 하는 경우에는, 해당 개인정보를 별도의 데이터 베이스(DB)로 옮기거나 보관장소를 달리하여 보존합니다.'),
                
                const Text(' 개인정보 파기의 절차 및 방법은 다음과 같습니다.'),
                const Text(' 1. 파기절차'),
                const Text(' ❮My Special Diary❯는 파기 사유가 발생한 개인정보를 선정하고, ❮My Special Diary❯의 개인 정보 보호책임자의 승인을 받아 개인정보를 파기합니다.'),
                const Text(' 2. 파기방법'),
                const Text(' ❮My Special Diary❯는 전자적 파일 형태로 기록•저장된 개인정보는 기록을 재생할 수 없도록 파기하며, 종이 문서에 기록•저장된 개인정보는 분쇄기로 분쇄하거나 소각하여 파기합니다'),
                ...
                const Text('① 정보주체는 ❮My Special Diary❯에 대해 언제든지 개인정보 열람•정정·삭제•처리정지 요구 등의 권리를 행사할 수 있습니다.'),
                ...
                const Text('② 권리 행사는 ❮My Special Diary❯에 대해 「개인정보 보호법」 시행령 제41조 제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며, ❮My Special Diary❯는 이에 대해 지체없이 조치하겠습니다.'),
                ...
                const Text('이 경우 "개인정보 처리 방법에 관한 고시(제2020-7호)" 별지 제11호 서식에 따른 위임장을 제출하셔야 합니다.'),
                const Text(' ❮My Special Diary❯는 정보주체 권리에 따른 열람의 요구, 정정•삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.'),
                ...
                const Text(' ❮My Special Diary❯는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.'),
                ...
                const Text(' ❮My Special Diary❯는 모바일 앱에서 온라인 맞춤형 광고를 위하여 광고식별자를 수집•이용 합니다. 정보주체는 모바일 단말기의 설정 변경을 통해 앱의 맞춤형 광고를 차단·허용할 수 있습니다.'),
                ...
                const Text('① ❮My Special Diary❯는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.'),
                const Text('• 개인정보 보호책임자'),
                const Text('    성명: 박설아'),
                const Text('    연락처: seolaox89@gmail.com'),
                const Text('② 정보주체는 ❮My Special Diary❯의 서비스를 이용하시면서 발생한 모든 개인정보보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의할 수 있습니다. ❮My Special Diary❯는 정보주체의 문의에 대해 지체없이 답변 및 처리해드릴 것입니다.'),
                const SizedBox(
                  height: 30,
                ),
                const Text(
